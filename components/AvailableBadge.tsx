...
const AvailableBadge = () => {
  return (
    <div className="z-50 fixed bottom-5  right-7 flex items-center gap-1 bg-[rgb(37,36,37)] text-white p-1 px-3 rounded-3xl border-black shadow-[0_2px_4px_rgb(0,0,0,0.5)] border">
